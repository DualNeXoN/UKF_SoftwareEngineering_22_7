        ...
        <div class="row">
            @if(count($practices) == 0)
                <div class="col-12 text-center">
                    <p><strong>No professional practices in database</strong></p>
                </div>
            @else
                ...
                <div class="col-12 col-md-12 col-lg-6 my-2">
                    <div class="card @if($practice->isAvailable()) border-primary @elseif(Session::has('user') && $practice->isUserAssigned(Session::get('user')['id'])) border-success @else border-danger @endif text-center">
                        <div class="card-body">
                            ...
                            <hr>
                            <p class="card-text"><strong>Company: </strong>{{ $practice->company()->name }}</p>
                            <hr>
                            <p class="card-text"><strong>Contract Type: </strong>{{ $practice->contractType()->contract }}</p>
                            <hr>
