            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-6 col-lg-4 mb-5">
                    <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal1">
                        ...
                        <img class="img-fluid img-sc" src="{{ asset('img/users.png') }}" alt="..." />
                    </div>
                </div>
                <!-- Item 2-->
                <div class="col-md-6 col-lg-4 mb-5">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 ms-auto">
                    <p class="lead">We are Lucky Seven and this is our project PPUtils. We manage students, companies and department.</p>
                </div>
                <div class="col-lg-4 me-auto">
                    <p class="lead">You can join us today and be part of our team!</p>
                </div>
            </div>
