<nav class="navbar navbar-expand-md bg-nav">
    <div class="container-fluid">
        <a href="/"><img src="{{ asset('img/logo_pputils_t.png') }}" alt="" width="75"
        ...
        <div class="collapse navbar-collapse" id="mynavbar">
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    <a class="navbar-brand nav-link dropdown-toggle mx-2 mw" href="#" id="navbarDropdown"
        ...
        @else
            ...
            <form class="d-flex" method="POST" action="{{ route('login-user') }}">
                ...
                <div class="forms-inputs collapse navbar-collapse" id="mynavbar">
                    <input type="text" name="uid" value="" placeholder="Ais ID"
                        class="form-control-lg input-w" />
                ...
                <div class="forms-inputs btwn-2 collapse navbar-collapse" id="mynavbar">
                    <input type="password" name="password" id="password" placeholder="Password"
                        class="form-control form-control-lg input-w" />
                    <span class="text-danger">
                        @error('password')
                            {{ $message }}}
                        @enderror
                ...
                <button class="btn-control btn btn-outline-dark btn-lg px-4 btwn-2 collapse navbar-collapse"
                    id="mynavbar" type="submit">Log in</button>
            </form>
            <!-- Sign Up modal -->
            <button class="btn btn-outline-dark btn-lg px-4 btwn" data-bs-toggle="modal" data-bs-target="#registerModal"
