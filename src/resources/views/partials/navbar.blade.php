<nav class="navbar navbar-expand-lg bg-nav">
    <div class="container-fluid">
            ...
            @if (Session::has('user'))
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav">
                        ...
                        @if (\App\Http\Controllers\PermissionController::checkPermision([4]))
                            <!--
                        ...
                        @elseif(\App\Http\Controllers\PermissionController::checkPermision([1]))
                            <!--
                        ...
                        @elseif(\App\Http\Controllers\PermissionController::checkPermision([5]))
                            <!--
                        ...
                        @elseif(\App\Http\Controllers\PermissionController::checkPermision([2]))
                            <!--

                         SEM IDU KOMPONENTY PRE VEDUCEHO ODDELENIA

                        -->
                        @elseif(\App\Http\Controllers\PermissionController::checkPermision([3]))
                            <!--
                        ...
                        -->
                            <li class="nav-item">
                                <a class="nav-link active mw mx-2" href="/">Practices</a>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link active dropdown-toggle mw mx-2" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    Archive
        ...
        <a href="/logout">
            <button class="btn-control btn btn-outline-dark my-sm-0 mr btwn-2 my-2" id="mynavbar" type="submit">{{ __('translation.logout') }}</button>
        </a>
    @else
        <!-- Login form -->
        @if (Session::has('fail'))
